...
int main() {
    ...
    bool t = true;
    int v = 89;
    w.SaveText("pushpa","jhukega nai sala");
    w.SaveBoolean("b1 or b2",true);
    w.SaveNumber("num_var",345);
    cout<<w.LoadBoolean("b1 or b2",false)<<endl;
    cout<<w.LoadNumber("num_var",9)<<endl;
    cout<<w.LoadText("pushpa","hi")<<endl;
    system("pause");
}